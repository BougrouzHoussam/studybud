# Generated by Django 4.0.3 on 2022-06-10 01:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Agency', 'Agency'), ('Client', 'Client')], default='Client', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripation', models.CharField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('update', models.DateTimeField(auto_now=True)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.offer')),
            ],
            options={
                'ordering': ['-update', '-created'],
            },
